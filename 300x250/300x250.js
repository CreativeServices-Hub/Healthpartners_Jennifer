...
lib.ssMetadata = [
		...
		{name:"300x250_atlas_NP_1", frames: [[0,0,627,522]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance_4 = new lib._320x250();
	this.instance_4.setTransform(-6,0,0.5104,0.5103);
...
p.nominalBounds = new cjs.Rectangle(144,125,170,141.39999999999998);
// library properties:
lib.properties = {
