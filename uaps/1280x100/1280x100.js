...
lib.ssMetadata = [
		{name:"1280x100_atlas_P_1", frames: [[1314,0,291,724],[0,404,790,195],[0,0,1214,236],[0,238,1312,164],[792,404,519,88],[0,601,1046,88]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-212,-218,0.2172,0.2172);
...
p.nominalBounds = new cjs.Rectangle(-212,-218,63.19999999999999,157.3);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(706.6,54.8,0.6996,0.6996);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({scaleX:1,scaleY:1,alpha:1,startPosition:21},21,cjs.Ease.backOut).wait(219));

	// Symbol_2
	this.instance_3 = new lib.Symbol2("synched",0);
	this.instance_3.setTransform(20.2,50.1,0.6354,0.6358,0,0,0,-180.2,-139.3);
	...
	this.shape.setTransform(640.125,49.925);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance_5},{t:this.instance_4}]}).wait(240));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(637,46,646.3,57.900000000000006);
// library properties:
lib.properties = {
